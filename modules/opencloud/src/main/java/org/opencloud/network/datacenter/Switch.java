...
public class Switch extends SimEntity {
	...
	protected void processPacketDown(SimEvent ev) {
		...
		OpenCloud.cancelAll(getId(), new PredicateType(CloudActionTags.NETWORK_PKT_FORWARD));
	...
	/*protected void processpacket(SimEvent ev) {
		...
		OpenCloud.cancelAll(getId(), new PredicateType(CloudActionTags.NETWORK_PKT_UP));
