...
public class CompositeGenerator<T> implements IGenerator<Collection<T>> {
     ...
     * (non-Javadoc)
     * 
     * @see org.opencloud.incubator.web.IGenerator#peek()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.opencloud.incubator.web.IGenerator#poll()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.opencloud.incubator.web.IGenerator#isEmpty()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.opencloud.incubator.web.IGenerator#notifyOfTime(double)
     */
    @Override
