...
import org.opencloud.CloudletScheduler;
import org.opencloud.Pe;
import org.opencloud.EX.VmSchedulerMapVmsToPes;
import org.opencloud.EX.vm.MonitoredVmEX;
import org.opencloud.EX.vm.VMMetadata;
...
/**
 * A virtual machine with a harddisk. Unlike the other OpenCloud implementations
...
public class HddVm extends MonitoredVmEX {
     ...
     * (non-Javadoc)
     * 
     * @see org.opencloud.Vm#updateVmProcessing(double, java.util.List)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.opencloud.Vm#getCloudletScheduler()
     */
    @Override
