...
import org.opencloud.lists.PeList;
...
public class HddHost extends Host {
     ...
     * (non-Javadoc)
     * 
     * @see org.opencloud.Host#updateVmsProcessing(double)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.opencloud.Host#vmCreate(org.opencloud.Vm)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.opencloud.Host#getVmList()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.opencloud.Host#setFailed(boolean)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.opencloud.Host#setFailed(java.lang.String, boolean)
     */
    @Override
