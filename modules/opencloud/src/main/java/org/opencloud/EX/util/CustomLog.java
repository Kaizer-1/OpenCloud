...
/**
 * Replaces the primitive functionality of the standard OpenCloud Log. Allows
...
public class CustomLog {
     ...
     * contain the current OpenCloud time.
     */
    public static final String LOG_SIM_CLOCK_PROP_KEY = "LogSimClock";

    /**
     * A key for a boolean property, specifying if every log entry should
     * contain with the current OpenCloud time in a readable format.
     */
    ...
    /**
     * A key for a boolean property specifying whether the standard OpenCloud
     * logger should be turned off. That will cause all the log generated by the
     * system classes of OpenCloud not to be printed.
     */
    ...
    public static void configLogger(final Properties props) throws SecurityException, IOException {
        ...
        final boolean prefixSimClock = Boolean.parseBoolean(props
                .getProperty(LOG_SIM_CLOCK_PROP_KEY, "false").trim());
        final boolean prefixReadableSimClock = Boolean.parseBoolean(props
        ...
        formatter = new CustomFormatter(prefixSimClock, prefixReadableSimClock, prefixRealTimeClock, format);
    ...
    private static class CustomFormatter extends Formatter {
        ...
        private final boolean prefixSimClock;
        private final boolean prefixReadableSimClock;
        private final boolean prefixRealTimeClock;
        private final String format;
        SimpleFormatter defaultFormatter = new SimpleFormatter();

        public CustomFormatter(final boolean prefixSimClock, final boolean prefixReadableSimClock,
                final boolean prefixRealTimeClock, final String format) {
            super();
            this.prefixSimClock = prefixSimClock;
            this.prefixReadableSimClock = prefixReadableSimClock;
        ...
        public String format(final LogRecord record) {
            ...
            if (prefixSimClock) {
                result.append(TextUtil.toString(OpenCloud.clock())).append("\t");
            }
            if (prefixReadableSimClock) {
                result.append(TextUtil.getReadableTime(OpenCloud.clock())).append("\t");
            }
