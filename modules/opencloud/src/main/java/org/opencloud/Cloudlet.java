...
public class Cloudlet {
     ...
     * <p>
     * //@TODO See
     * <a href="https://groups.google.com/forum/#!topic/opencloud/MyZ7OnrXuuI">this
     * discussion</a>
     */
    ...
    /** Backward compatibility with ResCloudlet class in OpenCloud6G */
    @Deprecated
    ...
    public void finalizeCloudlet() {
        ...
        double wallClockTime = OpenCloud.clock() - getSubmissionTime();
    ...
    public void setUserId(final int id) {
        ...
        updateUid();
        if (record) {
            write("Assigns the Cloudlet to " + OpenCloud.getEntityName(id) + " (ID #" + id + ")");
        }
    }
    ...
    public void setResourceParameter(final int resourceID, final double cost) {
        ...
        res.costPerSec = cost;
        res.resourceName = OpenCloud.getEntityName(resourceID);
        ...
        setSubmissionTime(OpenCloud.clock());
    }
    ...
    public boolean updateStatus(final CloudletStatus status) {
        ...
        if (status == CloudletStatus.SUCCESS) {
            execFinishTime = OpenCloud.clock();
        }

        double clock = OpenCloud.clock();
        this.status = status;
    ...
    protected void write(final String str) {
        ...
        if (num == null || history == null) { // Creates the history or
            ...
            history.append("------------------------------------------");
            history.append(System.getProperty("line.separator"));
            history.append(num.format(OpenCloud.clock()));
