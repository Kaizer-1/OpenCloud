...
public class VmList {
	 ...
	 * @post $none
         ...
         * VM id uniqueness is a OpenCloud requirement)
	...
	public static <T extends GuestEntity> void sortByCpuUtilization(List<T> vmList) {
		vmList.sort((a, b) -> {
			Double aUtilization = a.getTotalUtilizationOfCpuMips(OpenCloud.clock());
			Double bUtilization = b.getTotalUtilizationOfCpuMips(OpenCloud.clock());
