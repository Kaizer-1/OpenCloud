...
import org.opencloud.NetworkTopology;
 ...
 * <ul>
 * <li> {@link #startEntity()} is invoked by the {@link OpenCloud} class when the simulation is
 * started. This method should be responsible for starting the entity up.
 * <li> {@link #processEvent(SimEvent)} is invoked by the {@link OpenCloud} class whenever there is
 * an event in the deferred queue, which needs to be processed by the entity.
 * <li> {@link #shutdownEntity()} is invoked by the {@link OpenCloud} before the simulation
...
public abstract class SimEntity implements Cloneable {
	 ...
	 */
	public void schedule(int dstId, double delay, OpenCloudTags tag, Object data) {
		if (!OpenCloud.running()) {
			return;
		}
		OpenCloud.send(id, dstId, delay, tag, data);
	}
	 ...
	 * @param tag event type.
	 */
	public void schedule(int dstId, double delay, OpenCloudTags tag) {
	 ...
	 * @param data The data to be sent with the event.
	 */
	public void schedule(String dstName, double delay, OpenCloudTags tag, Object data) {
		schedule(OpenCloud.getEntityId(dstName), delay, tag, data);
	}
	 ...
	 * @param tag event type.
	 */
	public void schedule(String dstName, double delay, OpenCloudTags tag) {
	 ...
	 * @param data The data to be sent with the event.
	 */
	public void scheduleNow(int dstId, OpenCloudTags tag, Object data) {
	 ...
	 * @param tag event type.
	 */
	public void scheduleNow(int dstId, OpenCloudTags tag) {
	 ...
	 * @param data The data to be sent with the event.
	 */
	public void scheduleNow(String dstName, OpenCloudTags tag, Object data) {
		schedule(OpenCloud.getEntityId(dstName), 0, tag, data);
	}
	 ...
	 * @param tag event type.
	 */
	public void scheduleNow(String dstName, OpenCloudTags tag) {
	 ...
	 * @param data The data to be sent with the event.
	 */
	public void scheduleFirst(int dstId, double delay, OpenCloudTags tag, Object data) {
		if (!OpenCloud.running()) {
			return;
		}
		OpenCloud.sendFirst(id, dstId, delay, tag, data);
	}
	 ...
	 * @param tag event type.
	 */
	public void scheduleFirst(int dstId, double delay, OpenCloudTags tag) {
	 ...
	 * @param data The data to be sent with the event.
	 */
	public void scheduleFirst(String dstName, double delay, OpenCloudTags tag, Object data) {
		scheduleFirst(OpenCloud.getEntityId(dstName), delay, tag, data);
	}
	 ...
	 * @param tag event type.
	 */
	public void scheduleFirst(String dstName, double delay, OpenCloudTags tag) {
	 ...
	 * @param data The data to be sent with the event.
	 */
	public void scheduleFirstNow(int dstId, OpenCloudTags tag, Object data) {
	 ...
	 * @param tag event type.
	 */
	public void scheduleFirstNow(int dstId, OpenCloudTags tag) {
	 ...
	 * @param data The data to be sent with the event.
	 */
	public void scheduleFirstNow(String dstName, OpenCloudTags tag, Object data) {
		scheduleFirst(OpenCloud.getEntityId(dstName), 0, tag, data);
	}
	 ...
	 * @param tag event type.
	 */
	public void scheduleFirstNow(String dstName, OpenCloudTags tag) {
	...
	public int numEventsWaiting() {
		return waiting(OpenCloud.SIM_ANY);
	}
	...
	/**
	 * This method is invoked by the {@link OpenCloud} class when the simulation is started. 
	 * It should be responsible for starting the entity up.
	 */
	public void startEntity() {
		Log.printlnConcat(OpenCloud.clock(), ": ", getName(), " is starting...");
	}

	/**
	 * Processes events or services that are available for the entity.
	 * This method is invoked by the {@link OpenCloud} class whenever there is an event in the
	 ...
	 * This method is invoked by the {@link OpenCloud} before the simulation finishes. If you want
	 * to save data in log files this is the method in which the corresponding code would be placed.
	 */
	public void shutdownEntity() {
		Log.printlnConcat(OpenCloud.clock(), ": ", getName(), " is shutting down...");
		incomingEvents = null;
	 ...
	 * in the {@link #processEvent(org.opencloud.core.SimEvent)} method.
	 *
	 * @see #processEvent(org.opencloud.core.SimEvent)
	 */
	public void run() {
	 ...
	 * @param simTag an user-defined number representing the type of an event/message
	 ...
	 * @post $none
	 */
	protected void send(int dstId, double delay, OpenCloudTags simTag, Object data) {
		if (dstId < 0) {
			return;
		}
		...
		schedule(dstId, delay, simTag, data);
	}
	 ...
	 * @post $none
	 */
	protected void send(int dstId, double delay, OpenCloudTags tag) {
	 ...
	 * @post $none
	 */
	protected void send(String dstName, double delay, OpenCloudTags tag, Object data) {
		send(OpenCloud.getEntityId(dstName), delay, tag, data);
	}
	 ...
	 * @post $none
	 */
	protected void send(String dstName, double delay, OpenCloudTags tag) {
	 ...
	 * @post $none
	 */
	protected void sendNow(int dstId, OpenCloudTags tag, Object data) {
	 ...
	 * @post $none
	 */
	protected void sendNow(int dstId, OpenCloudTags tag) {
	 ...
	 * @post $none
	 */
	protected void sendNow(String dstId, OpenCloudTags tag, Object data) {
		send(OpenCloud.getEntityId(dstId), 0, tag, data);
	}
	 ...
	 * @post $none
	 */
	protected void sendNow(String dstName, OpenCloudTags tag) {
