 ...
 */
public enum CloudActionTags implements OpenCloudTags {
	BLANK,
	 ...
	 * {@link OpenCloudShutdown} to trigger the end of the simulation
	 */
	 ...
	 * tag is normally used between {@link CloudInformationService} and OpenCloud entity.
	 */
	RESOURCE_LIST,

	/**
	 * Denotes a list of hostList's that only support advance reservation. This tag is normally used
	 * between {@link CloudInformationService} and OpenCloud entity.
	 */
	RESOURCE_AR_LIST,

	/**
	 * Denotes cloud resource characteristics information. This tag is normally used between OpenCloud
	 * and CloudResource entity.
	 */
	RESOURCE_CHARACTERISTICS,

	/**
	 * Denotes cloud resource allocation policy. This tag is normally used between OpenCloud and
	 ...
	 * between OpenCloud and CloudResource entity.
	 */
	 ...
	 * Denotes the submission of a Cloudlet. 
         * This tag is normally used between OpenCloud User and CloudResource entity.
	 */
	CLOUDLET_SUBMIT,

	/**
	 * Denotes the submission of a Cloudlet with an acknowledgement. This tag is normally used
	 * between OpenCloud User and CloudResource entity.
	 */
	CLOUDLET_SUBMIT_ACK,
