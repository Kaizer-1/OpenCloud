 ...
 * summary, it acts like a yellow page service. This class will be created by OpenCloud upon
...
public class CloudInformationService extends SimEntity {
	...
	/** A list containing the id of all entities that are registered at the 
         ...
         * It can be seen at the method {@link #processEvent(org.opencloud.core.SimEvent)}
	...
	protected void processOtherEvent(SimEvent ev) {
		...
		Log.println("CloudInformationSevice.processOtherEvent(): " + "Unable to handle a request from "
				+ OpenCloud.getEntityName(ev.getSourceId()) + " with event tag = " + ev.getTag());
	}
	...
	private void notifyAllEntity() {
		Log.printlnConcat(OpenCloud.clock(), ": ", super.getName(), ": Notify all OpenCloud entities for shutting down.");
