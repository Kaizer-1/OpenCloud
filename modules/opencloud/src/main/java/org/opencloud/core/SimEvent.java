...
public class SimEvent implements Cloneable, Comparable<SimEvent> {
	...
	private final OpenCloudTags tag;
	...
	private final Object data;
        ...
        /**
         * An attribute to help OpenCloud to identify the order of received events
         ...
         * the {@link #compareTo(org.opencloud.core.SimEvent)}
	...
	SimEvent(int type, double time, int src, int dest, OpenCloudTags tag, Object edata) {
		etype = type;
		this.time = time;
		entSrc = src;
		entDst = dest;
	...
	public String toString() {
		return "Time ="+this.time+", Event tag = " + tag + " source = " + OpenCloud.getEntity(entSrc).getName() + " destination = "
				+ OpenCloud.getEntity(entDst).getName();
	}
