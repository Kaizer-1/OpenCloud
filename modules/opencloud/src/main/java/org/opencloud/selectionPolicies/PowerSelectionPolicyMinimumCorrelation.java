...
import org.opencloud.container.utils.Correlation;
 ...
 * Loosely based on HostSelectionPolicyMinimumCorrelation from the previous version of OpenCloud
 *
...
public class PowerSelectionPolicyMinimumCorrelation implements SelectionPolicy<PowerHostEntity> {
    ...
    public PowerHostEntity select(List<PowerHostEntity> candidates, Object obj, Set<PowerHostEntity> excludedCandidates) {
        ...
        if (selectedHost == null) {
            Log.printlnConcat(OpenCloud.clock(), ": ", getClass().getSimpleName(), ": fallback activated (No host found)");
