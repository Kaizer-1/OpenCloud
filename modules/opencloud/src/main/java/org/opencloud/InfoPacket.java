/*
 * ** Network and Service Differentiation Extensions to OpenCloud 3.0 **
 *
...
public class InfoPacket implements Packet {
	...
	/** Whether the packet is going or returning, according to 
         * constants {@link  OpenCloudTags#INFOPKT_SUBMIT}
         * and {@link  OpenCloudTags#INFOPKT_RETURN}. */
	private OpenCloudTags tag;
	...
	public String toString() {
		...
		for (int i = 0; i < entities.size(); i++) {
			...
			sb.append(OpenCloud.getEntityName(resID)).append("\t\t");
	 ...
	 * 
	 * @param time current simulation time, use {@link gridsim.OpenCloud#clock()} to obtain this
	 * @pre time >= 0
	 * @post $none
         * 
	 */
	 ...
	 * @post $none
	 */
	public boolean setTag(OpenCloudTags tag) {
		boolean flag;
