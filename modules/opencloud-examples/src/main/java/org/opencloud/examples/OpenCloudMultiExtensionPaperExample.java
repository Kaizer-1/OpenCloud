...
import org.opencloud.EX.DatacenterBrokerEX;
...
import org.opencloud.core.VirtualEntity;
import org.opencloud.distributions.ExponentialDistr;
import org.opencloud.examples.network.datacenter.NetworkConstants;
import org.opencloud.network.datacenter.*;
...
import org.opencloud.selectionPolicies.SelectionPolicyLeastFull;
...
public class OpenCloudMultiExtensionPaperExample {
	...
	// For reproducibility purposes (for the OpenCloud 7G paper):
	...
	/**
	 *
	 * A customised version of TandemAppExample5 for the OpenCloud7G lab presentation and Wiley SPE paper.
	 *
