...
/**
 * This Example is following the format for {@link org.opencloud.examples.power.planetlab.Dvfs}
...
public class ContainerSelectionTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0 ; i < repeat; i++) {
            ...
            /**
             * Getting the path of the planet lab workload that is included in the OpenCloud Package
             */
             ...
             */
            String outputFolder = "/tmp/ContainerOpenCloudResults";
            /**
