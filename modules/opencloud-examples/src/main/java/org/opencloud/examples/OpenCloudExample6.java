 ...
 */
public class OpenCloudExample6 {
	...
	public static void main(String[] args) {
		Log.println("Starting OpenCloudExample6...");
		...
		try {
			...
			//Datacenters are the resource providers in OpenCloud. We need at least one of them to run a OpenCloud simulation
			...
			Log.println("OpenCloudExample6 finished!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
