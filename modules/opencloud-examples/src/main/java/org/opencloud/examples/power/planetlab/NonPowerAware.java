package org.opencloud.examples.power.planetlab;
...
import org.opencloud.examples.power.Constants;
import org.opencloud.examples.power.Helper;
import org.opencloud.power.PowerDatacenterNonPowerAware;
...
public class NonPowerAware {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			OpenCloud.terminateSimulation(Constants.SIMULATION_LIMIT);
