 ...
 * Description:  OpenCloud (Cloud Simulation) Toolkit for Modeling and Simulation
 *               of Clouds
...
package org.opencloud.examples.web;

import org.opencloud.*;
import org.opencloud.core.OpenCloud;
import org.opencloud.EX.disk.*;
import org.opencloud.EX.util.CustomLog;
import org.opencloud.EX.util.TextUtil;
import org.opencloud.web.ILoadBalancer;
import org.opencloud.web.SimpleDBBalancer;
import org.opencloud.web.SimpleWebLoadBalancer;
import org.opencloud.web.WebCloudlet;
import org.opencloud.web.workload.StatWorkloadGenerator;
import org.opencloud.web.workload.brokers.WebBroker;
import org.opencloud.web.workload.freq.CompositeValuedSet;
import org.opencloud.web.workload.freq.FrequencyFunction;
import org.opencloud.web.workload.freq.PeriodicStochasticFrequencyFunction;
import org.opencloud.web.workload.sessions.ConstSessionGenerator;
import org.opencloud.web.workload.sessions.ISessionGenerator;
...
public class OpenCloudWorkloadWebExample {
	...
	try {
	    // Step1: Initialize the OpenCloud package. It should be called
	    // before creating any entities.
	    int numBrokers = 1; // number of brokers we'll be using
	    boolean trace_flag = false; // mean trace events

	    // Initialize OpenCloud
	    OpenCloud.init(numBrokers, Calendar.getInstance(), trace_flag);

	    // Step 2: Create Datacenters - the resource providers in OpenCloud
