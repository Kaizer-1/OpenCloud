...
/**
 * A simple example showing the use of containers (ContainerOpenCloud) and Vms (base OpenCloud) in the same contexts.
 */
public class OpenCloudMultiExtensionExample1 {
	/** The host list. */
	...
	public static void main(String[] args) {
		Log.println("Starting OpenCloudMultiExtensionExample1...");

		try {
			// Initialize the OpenCloud package. It should be called before creating any entities.
