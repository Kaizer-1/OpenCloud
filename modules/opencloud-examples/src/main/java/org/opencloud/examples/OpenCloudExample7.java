 ...
 * dynamically.
 */
public class OpenCloudExample7 {
	...
	public static void main(String[] args) {
		Log.println("Starting OpenCloudExample7...");
		...
		try {
			...
			Runnable monitor = () -> {
				OpenCloud.pauseSimulation(200);
				while (true) {
					if (OpenCloud.isPaused()) {
						break;
					}
					try {
						Thread.sleep(100);
				...
				Log.println("\n\n\n" + OpenCloud.clock() + ": The simulation is paused for 5 sec \n\n");
			...
			Log.println("OpenCloudExample7 finished!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
