...
import org.opencloud.container.resourceAllocatorMigrationEnabled.PowerContainerVmAllocationPolicyMigrationStaticThresholdMC;
import org.opencloud.container.resourceAllocatorMigrationEnabled.PowerContainerVmAllocationPolicyMigrationStaticThresholdMCUnderUtilized;
import org.opencloud.VmAllocationWithSelectionPolicy;
import org.opencloud.core.*;
import org.opencloud.selectionPolicies.PowerSelectionPolicyMaximumCorrelation;
import org.opencloud.selectionPolicies.PowerSelectionPolicyMaximumCorrelation2;
import org.opencloud.selectionPolicies.SelectionPolicyMaximumUsage;
import org.opencloud.selectionPolicies.*;
...
/**
 * The RunnerAbs Class is the modified version of {@link org.opencloud.examples.power.RunnerAbstract}
...
//            PowerContainerDatacenter e = (PowerContainerDatacenter) HelperEx.createDatacenter("Datacenter", PowerContainerDatacenter.class, hostList, vmAllocationPolicy, containerAllocationPolicy);
            ...
            OpenCloud.terminateSimulation(86400.0D);
            double lastClock = OpenCloud.startSimulation();
