...
import org.opencloud.EX.util.Id;
...
/**
 * Demonstrates how to model disk I/O operations in OpenCloudEx. This example
 * uses a single host machine with two disks. Each disk has 2 data items.
 * 
 * @author nikolay.grozev
 * 
 */
public class OpenCloudDisksExample {
    ...
    // NOTE! this is actually not used by OpenCloudEx
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Step 2: Initialise OpenCloud. We'll use only 1 broker in this example
        ...
        CustomLog.printf(Level.FINEST, "\nCloudletID=%d currentTime=%f, remainLen=%d, remainIOLen=%d)",
                cloudlet1_1.getCloudletId(), OpenCloud.clock(), cloudlet1_1.getCloudletLength(),
                cloudlet1_1.getCloudletIOLength());
        CustomLog.printf(Level.FINEST, "\nCloudletID=%d currentTime=%f, remainLen=%d, remainIOLen=%d)",
                cloudlet1_2.getCloudletId(), OpenCloud.clock(), cloudlet1_2.getCloudletLength(),
