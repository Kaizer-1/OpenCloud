...
import org.opencloud.core.SimEntity;
 ...
 */
public class OpenCloudExample8 {
	...
	public static void main(String[] args) {
		Log.println("Starting OpenCloudExample8...");
		...
		try {
			...
			Log.println("OpenCloudExample8 finished!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	public static class GlobalBroker extends SimEntity {
		protected enum ExampleTags implements OpenCloudTags {
			CREATE_BROKER
		}
