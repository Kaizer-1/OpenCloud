...
package org.opencloud.examples.network;
...
import org.opencloud.CloudletSchedulerTimeShared;
...
import org.opencloud.UtilizationModel;
import org.opencloud.UtilizationModelFull;
import org.opencloud.Vm;
import org.opencloud.VmAllocationPolicySimple;
import org.opencloud.VmSchedulerSpaceShared;
...
public class NetworkExample3 {
	...
	public static void main(String[] args) {
		...
		try {
			// First step: Initialize the OpenCloud package. It should be called
			...
			//Datacenters are the resource providers in OpenCloud. We need at list one of them to run a OpenCloud simulation
			...
			//maps OpenCloud entities to BRITE entities
