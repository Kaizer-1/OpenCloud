package org.opencloud.examples.container;


/*
 * Title:        ContainerOpenCloudExample1 Toolkit
 * Description:  ContainerOpenCloudExample1 (containerized cloud simulation) Toolkit for Modeling and Simulation
...
import org.opencloud.container.core.*;
...
import org.opencloud.selectionPolicies.SelectionPolicyFirstFit;
import org.opencloud.container.resourceAllocatorMigrationEnabled.PowerContainerVmAllocationPolicyMigrationAbstractHostSelection;
import org.opencloud.container.utils.IDs;
import org.opencloud.selectionPolicies.SelectionPolicyMaximumUsage;
 ...
 * Modified by Remo Andreoli (Feb 2024)
 */
public class ContainerOpenCloudExample1 {
    ...
    public static void main(String[] args) {
        Log.println("Starting ContainerOpenCloudExample1...");
        ...
        try {
            ...
            /**
             * 1- Like OpenCloud the first step is initializing the OpenCloud Package before creating any entities.
             *
             */
             ...
             */
            String logAddress = "/tmp/ContainerOpenCloudExample1";
            ...
            PowerContainerDatacenter e = (PowerContainerDatacenter) createDatacenter("datacenter",
                    ...
                    getExperimentName("ContainerOpenCloudExample-1", String.valueOf(overBookingFactor)),
             ...
             */
            OpenCloud.terminateSimulation(86400.00);
            /**
            ...
            Log.println("ContainerOpenCloudExample1 finished!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static List<Cloudlet> createContainerCloudletList(int brokerId, int numberOfCloudlets)
            throws FileNotFoundException {
        String inputFolderName = ContainerOpenCloudExample1.class.getClassLoader().getResource("workload/planetlab").getPath();

        java.io.File inputFolder1 = new java.io.File("modules/opencloud-examples/src/main/resources/workload/planetlab/");
